...
- [ ] **Auth (Microsoft Entra ID 연동)**: 조직 사용자만 접근할 수 있도록 Microsoft 로그인 적용
- [ ] **파일 검색 기능**: 업로드한 파일을 파일명으로 빠르게 검색하는 기능
- [ ] **즐겨찾기 기능**: 자주 사용하는 파일에 즐겨찾기(Star) 지정
- [ ] **디렉토리 분할 기능**: 사용자가 폴더(디렉토리)를 생성하여 파일을 구조적으로 관리
- [ ] **30일 자동 삭제 정책**: 사용(다운로드 등)이 30일 동안 없는 파일은 시스템에서 자동 삭제
- [ ] **공유 버튼 기능**: 다운로드 링크를 쉽게 복사할 수 있는 공유 버튼 추가
- [ ] **모바일 반응형 UI**: 스마트폰 환경에서도 편리하게 사용할 수 있도록 레이아웃 최적화
